...
from reid.evaluators import Evaluator_pcb
...
def main(args):
    ...
    # Create model
    model = pcb.PCB_resnet(args.arch, num_stripes=args.num_stripes, local_conv_out_channel=args.features,num_class=num_classes)
